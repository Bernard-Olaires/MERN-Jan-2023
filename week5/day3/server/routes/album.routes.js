...
module.exports = app => {
    ...
    app.get('/api/oneAlbum/:_id', AlbumController.getOneAlbum)
    app.post('/api/postAlbum', AlbumController.createAlbum)
    app.put('/api/updateAlbum/:_id', AlbumController.updateAlbum)
    app.delete('/api/deleteAlbum/:_id', AlbumController.deleteAlbum)
}